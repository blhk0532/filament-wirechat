<div class="h-full ">
    ...
    x-data="{
     ...
     class ='w-full h-full bg-[var(--wc-light-primary)] dark:bg-[var(--wc-dark-primary)] border border-[var(--wc-light-secondary)] dark:border-[var(--wc-dark-secondary)] flex overflow-hidden rounded-lg'>
      <div :class="chatIsOpen && 'hidden xl:grid'" class="relative  w-full h-full sm:border-r border-[var(--wc-light-border)] dark:border-[var(--wc-dark-border)]    md:w-[500px] lg:w-[500px] xl:w-500px] shrink-0 overflow-y-auto  ">
